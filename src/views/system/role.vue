        ...
        <el-dialog title="添加角色" widt :visible.sync="dialogFormVisibleAdd">
          <el-form ref="form" :model="form" :rules="formRules" class="identity add_user">
            ...
            <div>
              <span>选择菜单权限</span>
              <el-tree
                :data="data2"  show-checkbox node-key="id" default-expand-all 
                ref="tree"  highlight-current :props="defaultProps">
              </el-tree>
            ...
            <div class="clearfix">
              <div class="pull-right">
                <el-button @click="resetChecked">取消</el-button>
                <el-button type="primary" style="" @click="addHandle('form')">确认</el-button>
              </div>
            </div>
          </el-form>
        </el-dialog>
    ...
    data () {
      return {
        ...
        formRules: {
          ...
          code: [{ required: true, message: '角色值不能为空', trigger: 'blur' }]
        },
        form: {
          id: '',
          name: '',
