  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">易用链后台管理系统</a>
        <a class="site-navbar__brand-mini" href="javascript:;">易用</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        mode="horizontal">
        <el-menu-item class="site-navbar__avatar mr20" index="3">
    ...
    methods: {
      ...
      logoutHandle () {
        this.$confirm(`确定进行[退出]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/bs/manager/logout'),
            method: 'get',
